...
$title = "Edward Lin | Web Developer"
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <meta property="og:title" content="Edward Lin | About" />
...
<body>
    <div id="wrapper">
        ...
        <?php include_once "components/feat-works.php" ?>
        <?php include_once "components/intro.php" ?>
